...
function updateDate() {
  ...
  const fullDate = `${today.getDate()} ${today.toLocaleString("default", {
    month: "short",
  })} ${today.getFullYear()}`;
...
function updateWeatherUI(data) {
  if (data.current_weather) {
    ...
    if (weather.relative_humidity !== undefined) {
      humidityElement.textContent = `${Math.round(
  ...
  if (
    ...
    dayNameElements.forEach((dayNameElement, index) => {
      ...
      if (dayTempElements[index]) {
        dayTempElements[index].textContent = `${Math.round(
          dailyTemperatures[index]
        )}°C`;
      }
    ...
    if (precipitationElement) {
      precipitationElement.textContent = `${Math.round(
        dailyPrecipitation[0]
      )} %`; // Use today's precipitation
    }
  } else {
...
function getWeatherIcon(code) {
  const iconMap = {
    0: "../weather_app/assets/sun.svg", // Clear sky
    1: "../weather_app/assets/sun.svg", // Mainly clear
    2: "../weather_app/assets/partly-cloudy.svg", // Partly cloudy
    3: "../weather_app/assets/overcast.svg", // Overcast
    45: "../weather_app/assets/fog.svg", // Fog
    48: "../weather_app/assets/fog.svg", // Depositing rime fog
    51: "../weather_app/assets/drizzle.svg", // Light drizzle
    53: "../weather_app/assets/drizzle.svg", // Moderate drizzle
    55: "../weather_app/assets/drizzle.svg", // Dense drizzle
    56: "../weather_app/assets/freezing-drizzle.svg", // Light freezing drizzle
    57: "../weather_app/assets/freezing-drizzle.svg", // Dense freezing drizzle
    61: "../weather_app/assets/rain.svg", // Slight rain
    63: "../weather_app/assets/rain.svg", // Moderate rain
    65: "../weather_app/assets/heavy-rain.svg", // Heavy rain
    66: "../weather_app/assets/freezing-rain.svg", // Light freezing rain
    67: "../weather_app/assets/freezing-rain.svg", // Heavy freezing rain
    71: "../weather_app/assets/snow.svg", // Slight snow fall
    73: "../weather_app/assets/snow.svg", // Moderate snow fall
    75: "../weather_app/assets/heavy-snow.svg", // Heavy snow fall
    77: "../weather_app/assets/snow-grains.svg", // Snow grains
    80: "../weather_app/assets/rain-showers.svg", // Slight rain showers
    81: "../weather_app/assets/rain-showers.svg", // Moderate rain showers
    82: "../weather_app/assets/violent-rain.svg", // Violent rain showers
    85: "../weather_app/assets/snow-showers.svg", // Slight snow showers
    86: "../weather_app/assets/heavy-snow-showers.svg", // Heavy snow showers
    95: "../weather_app/assets/thunderstorm.svg", // Thunderstorm
    96: "../weather_app/assets/thunderstorm-hail.svg", // Thunderstorm with slight hail
    99: "../weather_app/assets/thunderstorm-heavy-hail.svg", // Thunderstorm with heavy hail
  };

  return iconMap[code] || "../weather_app/assets/sun.svg"; // Default icon if code doesn't match
}
...
function initializeWeatherApp() {
  updateDate();
  fetchWeather(
    locations[currentLocationIndex].lat,
    locations[currentLocationIndex].lon
  );
}
...
// Array of random background assets
const backgroundImages = [
  "../weather_app/assets/random_bg_1.png",
  "../weather_app/assets/random_bg_2.png",
  "../weather_app/assets/random_bg_3.png",
  "../weather_app/assets/random_bg_4.png",
  "../weather_app/assets/random_bg_5.png",
  "../weather_app/assets/random_bg_6.png",
  "../weather_app/assets/random_bg_7.png",
  "../weather_app/assets/random_bg_8.png",
  "../weather_app/assets/random_bg_9.png",
  "../weather_app/assets/random_bg_10.png",
];
